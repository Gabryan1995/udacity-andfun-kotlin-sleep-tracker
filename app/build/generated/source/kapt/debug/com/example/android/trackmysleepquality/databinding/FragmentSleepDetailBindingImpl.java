...
public class FragmentSleepDetailBindingImpl extends FragmentSleepDetailBinding implements com.example.android.trackmysleepquality.generated.callback.OnClickListener.Listener {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeSleepDetailViewModelNight((androidx.lifecycle.MediatorLiveData<com.example.android.trackmysleepquality.database.SleepNight>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeSleepDetailViewModelNight(androidx.lifecycle.MediatorLiveData<com.example.android.trackmysleepquality.database.SleepNight> SleepDetailViewModelNight, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MediatorLiveData<com.example.android.trackmysleepquality.database.SleepNight> sleepDetailViewModelNight = null;
